  ...
  try {
    ...
    if (isRecipientNotAllowedError(message)) {
      throw new SendMessageError(
        ...
        'This recipient is not in your WhatsApp allowed list. Add the number to your Meta WhatsApp sandbox/verified recipient list or use a verified business number.',
        400
      );
    }
